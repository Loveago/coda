...
type Props = {
  ...
  /** Show the raw payment state (incl. PENDING) instead of just PAID/FREE. */
...
export default function AdminManagementTable({ resource, records: initialRecords, showPaymentState = false }: Props) {
