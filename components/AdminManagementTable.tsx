    ...
    <section className="admin-panel" style={{ maxWidth: 'none', overflowX: 'auto' }}>
      ...
      {records.length === 0 ? <p>No records found.</p> : (
        <table className="admin-table card-table">
          <thead><tr>
            {resource === 'applications' && <><th>Name</th><th>Contact</th><th>Platform</th><th>Membership</th><th>Submitted</th><th>Action</th></>}
            ...
            {resource === 'work-applications' && <><th>Member</th><th>Position</th><th>Details</th><th>Status</th><th>Action</th></>}
