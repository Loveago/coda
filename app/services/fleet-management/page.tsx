      ...
      <main>
        <section className="page-hero">
          <div className="container">
            ...
            <h1>Fleet operations that stay in motion.</h1>
            <p>Mr Truth Agency helps businesses establish clearer processes around vehicles, drivers and fleet performance.</p>
            <Link href="/contact" className="btn btn-primary">TALK TO OUR TEAM <ArrowRight size={15} /></Link>
          </div>
        </section>
        <section className="container page-body">
          ...
          <article className="panel" style={{ marginTop: 22 }}>
            <p className="section-label">BUILT TO EXPAND</p>
            <h2>From operational support to connected fleet intelligence.</h2>
            <p className="form-note">The fleet-management foundation is intentionally modular so future tracking integrations, maintenance records, allocations and reporting workflows can be added without replacing the core experience.</p>
          </article>
        </section>
      </main>
      <SiteFooter
